...
const PostBar = () => {
    return(
        <div className="bar d-flex flex-row align-items-center justify-content-between pt-2 px-3">
            <div>
                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-heart mr-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
